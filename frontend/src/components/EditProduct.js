...
class EditProduct extends React.Component {
    ...
    onChange={this.onChangeDescription} value={this.props.location.state.product.description}></input>
                </div>
                <div className="form-group">
                    <label for="url">URL Image</label>
                    <input type="text" className="form-control mb-4" id="url" placeholder="Url Image"
    onChange={this.onChangeTextImage}value={this.props.location.state.product.image}></input>
                </div>
                <div className="form-group">
    ...
    onChange={this.onChangePrice} value={this.props.location.state.product.price}></input>
                ...
                <button type="submit" className="btn btn-info btn-block my-4" onSubmit={this.Register}>Editar</button>
            </form>
