...
class CompanyCategoryImage extends React.Component {
    constructor(props) {
        super(props);
    }
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <Link className="btn btn-primary btn-block" onClick={this.onclick}
                              to={{pathname:'/Products',state:{idCompany:this.props.company.id}}}>Ver Productos</Link>
                    </div>
...
export default CompanyCategoryImage;
